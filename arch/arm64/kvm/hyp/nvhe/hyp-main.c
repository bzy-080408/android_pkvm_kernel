...
static void __flush_debug_state(struct kvm_shadow_vcpu_state *shadow_state)
{
	struct kvm_vcpu *shadow_vcpu = &shadow_state->shadow_vcpu;
...
static void __sync_debug_state(struct kvm_shadow_vcpu_state *shadow_state)
{
	struct kvm_vcpu *shadow_vcpu = &shadow_state->shadow_vcpu;
	struct kvm_vcpu *host_vcpu = shadow_state->host_vcpu;
...
static void flush_shadow_state(struct kvm_shadow_vcpu_state *shadow_state)
{
	...
	if (!shadow_state_is_protected(shadow_state)) {
		...
		__flush_debug_state(shadow_state);
			      ...
			      u32 exit_reason)
{
	...
	if (!shadow_state_is_protected(shadow_state))
		__sync_debug_state(shadow_state);
