...
#define UCALL_PR_STR (UCALL_DONE + 1)
...
/* Print a uint64_t. */
#define UCALL_PR_U64 (UCALL_DONE + 2)
...
#define UCALL_PR_STR_U64 (UCALL_DONE + 3)
 ...
 */
static void guest_exception_handler(void)
{
	++num_exceptions;
}
...
static void guest_code(void)
{
	...
	aarch64_guest_exception_setup(guest_exception_handler);
