...
#define ARM_SMCCC_KVM_FUNC_START_TRACING	9
#define ARM_SMCCC_KVM_FUNC_STOP_TRACING		10
...
#define ARM_SMCCC_VENDOR_HYP_KVM_START_TRACING_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_KVM_FUNC_START_TRACING)

#define ARM_SMCCC_VENDOR_HYP_KVM_STOP_TRACING_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_KVM_FUNC_STOP_TRACING)
